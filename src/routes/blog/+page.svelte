...
<svelte:head>
	<title>Blog | true_log</title>
	<meta name="description" content="Public true_log posts" />
</svelte:head>

<main class="mx-auto w-full max-w-4xl px-4 py-12 text-gray-800">
	<section class="mb-8" aria-labelledby="blog-title">
		<p class="mb-2 text-sm font-bold text-indigo-600 uppercase">Blog</p>
		<h1 id="blog-title" class="text-4xl leading-tight font-bold sm:text-5xl">Public posts</h1>
	</section>

	{#if data.posts.length > 0}
		<ul class="m-0 grid list-none gap-4 p-0" aria-label="Blog posts">
